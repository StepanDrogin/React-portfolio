    ...
    <div className="container">
      ...
      <div className="footer__items">
        <div className="footer__item">
          ...
          <a
            href="mailto:drogenko.stepan@yandex.ru"
        ...
        <div className="footer__item">
          {/* eslint-disable-next-line */}
          <a
            href="https://www.linkedin.com/in/stepan-drogin-b0ab85215/"
            className="footer__item-link"
          >
        ...
        <div className="footer__item">
          {/* eslint-disable-next-line */}
          <a
            href="skype:[live:.cid.ef67230e60df834d]"
            className="footer__item-link"
          >
        ...
        <div className="footer__item">
          {/* eslint-disable-next-line */}
          <a
            href="https://github.com/StepanDrogin"
            target="_blank"
            className="footer__item-link"
          >
