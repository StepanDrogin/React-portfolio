    ...
    <div className="container">
      ...
      <div className="pages">
        <div className="page__left">
          <p className="page__p">
            This is also on of my landing page project, than i wrote on HTML and
            SCSS. You can look at source code by clicking on the image and going
            to the project repository in github.
          </p>
        ...
        <div className="page__right">
          ...
          <a href="https://github.com/StepanDrogin/Konstruct" target="_blank">
            <img
              src={KonstuctBackImage}
              className="page__image-front konstuct-front"
              alt="Nails"
            ></img>
            <img
              src={KonstuctFrontImage}
              className="page__image-back konstuct-back"
              alt="Nails"
            ></img>
          </a>
        </div>
